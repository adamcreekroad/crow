...
(function(Opal) {
  ...
  Opal.add_stubs(['$param', '$render', '$div', '$h1']);
  return (function($base, $super) {
    function $App(){};
    ...
    self.$param("foo", $hash2(["type"], {"type": $scope.get('String')}));

    self.$param("bar", $hash2(["type"], {"type": $scope.get('Integer')}));

    return ($a = ($b = self).$render, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, $a, $b, TMP_2;

    return ($a = ($b = self).$div, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $a, $b, TMP_3;

      return ($a = ($b = self).$h1, $a.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;

        return "Hello World!"}, TMP_3.$$s = self, TMP_3), $a).call($b)}, TMP_2.$$s = self, TMP_2), $a).call($b)}, TMP_1.$$s = self, TMP_1), $a).call($b);

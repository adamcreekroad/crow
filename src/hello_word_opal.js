...
(function(Opal) {
  ...
  Opal.add_stubs(['$flatten', '$concat', '$>=', '$+', '$p', '$<', '$greet']);
  (function($base, $super) {
    function $Array(){};
    var self = $Array = $klass($base, $super, 'Array', $Array);
    ...
    return (Opal.defn(self, '$concat', function(other) {
      var self = this;
  ...
  (function($base, $super) {
    function $Bar(){};
    var self = $Bar = $klass($base, $super, 'Bar', $Bar);

    var def = self.$$proto, $scope = self.$$scope;

    return (Opal.defn(self, '$foo', function() {
      var self = this;
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      function $Employee(){};
      var self = $Employee = $klass($base, $super, 'Employee', $Employee);

      var def = self.$$proto, $scope = self.$$scope;

      return (Opal.defn(self, '$initialize', function(name) {
        var self = this;
    ...
    (function($base) {
      ...
      (function($base) {
        var $Admin, self = $Admin = $module($base, 'Admin');
      ...
      (function($base, $super) {
        ...
        def.foo = def.bar = def.count = def.people = def.name = nil;
        Opal.defn(self, '$initialize', function(people, name) {
          var self = this;
          ...
          self.foo = ["foo1", "foo2"];
          self.bar = ["bar1", "bar2"];
          return self.foo.$concat(self.bar);
        });

        Opal.defn(self, '$greet', function() {
          var $a, $b, self = this;

          if ((($a = ($b = $rb_ge(self.count, 0), $b !== false && $b !== nil ?self.people : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        return (Opal.defn(self, '$greet_many_people', TMP_1 = function(people_override) {
          var $a, $b, self = this, $iter = TMP_1.$$p, block = $iter || nil, max_people = nil;

          if (people_override == null) {
            people_override = nil
          }
          TMP_1.$$p = null;
          max_people = ((($a = people_override) !== false && $a !== nil) ? $a : self.people);
          while ((($b = $rb_lt(self.count, max_people)) !== nil && (!$b.$$is_boolean || $b == true))) {
          self.$greet()};
          if (block !== false && block !== nil) {
            if (Opal.yieldX(block, [self.count, self.name]) === $breaker) return $breaker.$v};
          return self.count = 0;
        }), nil) && 'greet_many_people';
      })($scope.base, $scope.get('Employee'));
      ...
      (function($base, $super) {
        ...
        return (Opal.defn(self, '$serve', function() {
          var self = this;
    ...
    (function($base) {
      var $Workers, self = $Workers = $module($base, 'Workers');

      var def = self.$$proto, $scope = self.$$scope;

      (function($base, $super) {
        function $Cashier(){};
        var self = $Cashier = $klass($base, $super, 'Cashier', $Cashier);

        var def = self.$$proto, $scope = self.$$scope;

        return (Opal.defn(self, '$cash_out', function() {
          var self = this;
